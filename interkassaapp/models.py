...
class Invoice(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='intekassa', verbose_name=_("User"), editable=False)
    # user = models.ForeignKey('auth.User', verbose_name=_("User"), editable=False, on_delete=models.CASCADE)
...
class Payment(models.Model):
    ...
    invoice = models.OneToOneField(Invoice, blank=True, null=True, related_name='payment', verbose_name=_('Invoice'), on_delete=models.CASCADE)
